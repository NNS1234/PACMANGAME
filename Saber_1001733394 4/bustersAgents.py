...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        livingGhosts = gameState.getLivingGhosts()  #boolean  gives t or f
        ...
        min = float("inf")
        for action in legal:
           successor_ = Actions.getSuccessor(pacmanPosition, action)
           dist = self.distancer.getDistance(successor_,val) #calculate current  pos to the nearest pos
           if dist < min:
              min = dist
              act = action
